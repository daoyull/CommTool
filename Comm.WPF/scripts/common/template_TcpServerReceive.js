 ...
 * @returns {TcpServerReceiveResult}
 */
function receive(message) {
    ...
    // 发送收到的数据
    server.sendBuffer(remoteIp,message.data);

    ui.logInfo("-------Script End-------");
    ui.logEmptyLine();

    let result = new TcpServerReceiveResult();
